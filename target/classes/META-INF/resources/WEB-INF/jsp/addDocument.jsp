...
<form method="post" action="${baseURL}/admin/add?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data" id="divdata" '>	
<div class="generic-container">
		...
		<td><a onclick="edit()" id="Edit" class="btn btn-success custom-width">Add</a></td>
